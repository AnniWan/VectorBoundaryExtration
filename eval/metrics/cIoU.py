...
def compute_IoU_cIoU(input_json, gti_annotations):
    ...
    dt_coco = coco.loadRes(gti_annotations)
    ...
    for image_id in bar:
        ...
        for _idx, annotation in enumerate(annotations):
           ...
           # m = cocomask.decode(annotation['segmentation'])
...
if __name__ == "__main__":
    compute_IoU_cIoU(input_json="./predictions_acm_gcn_1.json",
                    gti_annotations="./res.json")
